...
export default function MPriceRangeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setPrice_range(initialValues.price_range);
    setPrice_range_name(initialValues.price_range_name);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MPriceRange(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MPriceRangeCreateForm")}
      {...rest}
    >
      <SelectField
        label="Price range"
