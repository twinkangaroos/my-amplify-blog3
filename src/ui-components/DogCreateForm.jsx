...
export default function DogCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setFree_word(initialValues.free_word);
    setImage_name(initialValues.image_name);
    setPublish_status(initialValues.publish_status);
    setAppeal_point(initialValues.appeal_point);
    setBuy_flag(initialValues.buy_flag);
