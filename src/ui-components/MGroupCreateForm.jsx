...
export default function MGroupCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setGroup_name(initialValues.group_name);
    setAdmin_flag(initialValues.admin_flag);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MGroup(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MGroupCreateForm")}
      {...rest}
    >
      <TextField
        label="Group name"
