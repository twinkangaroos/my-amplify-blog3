...
export default function MSizeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSize_name(initialValues.size_name);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MSize(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MSizeCreateForm")}
      {...rest}
    >
      <SelectField
        label="Size"
