...
export default function MGenderCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setGender_name(initialValues.gender_name);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MGender(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MGenderCreateForm")}
      {...rest}
    >
      <SelectField
        label="Gender"
