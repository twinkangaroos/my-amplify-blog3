...
export default function MPrefectureCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPrefecture_name(initialValues.prefecture_name);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MPrefecture(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MPrefectureCreateForm")}
      {...rest}
    >
      <SelectField
        label="Prefecture"
